    ...
    <div className="w-full h-[120px] p-2 shadow-lg flex items-center justify-between">
      <div className="w-[60%] h-full flex gap-5">
        ...
        <div className="w-[40%] h-full flex flex-col justify-center items-center">
          ...
          <div className="w-[100px] h-[50px] flex items-center justify-between rounded-lg bg-pink overflow-hidden shadow-lg text-green-400 border-2 border-green-400">
      ...
      <div>
        <div className="flex flex-col items-center justify-start gap-6 text-xl text-green-400 font-semibold">
          <span>Rs {price}/-</span>
          <RiDeleteBin5Line className="flex items-center justify-center w-[40px] h-[40px] bg-white hover:bg-gray-200 rounded-full cursor-pointer text-red-400" onClick={() => {dispatch(removeItem(id));
